 ...
 * @LastEditTime: 2022-10-18 14:54:51
...
std::vector<std::tuple<std::vector<Eigen::Vector2d>, double, double>> StGraph::loadObstacle(const DecisionMaking::Obstacle& obstacle) {
    ...
    for (int i = 0; i < obstacle.getPredictedTrajectoryNumber(); i++) {
        ...
        // // DEBUG
        // std::cout << "Ego vehicle start index: " << ego_vehicle_start_collision_index << std::endl;
        // std::cout << "Ego vehicle end index: " << ego_vehicle_end_collision_index << std::endl;
        // std::cout << "Obstacle start index: " << cur_obs_start_collision_index << std::endl;
        // std::cout << "Obstacle end index: " << cur_obs_end_collision_index << std::endl;
